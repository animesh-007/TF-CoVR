...
def main(args):
    ...
    save_dir = args.save_dir / f"r2p1d-kinectics-vid-embs-{args.frames_video}-all"
    
    save_dir.mkdir(exist_ok=True)
    # os.makedirs(save_dir.as_pofix
    ...
    visual_encoder = R2Plus1D(ckpt=None)
    ...
    for video_ids, video_raw in tqdm(loader):
        ...
        for video_id, video_raw_ft in zip(video_ids, video_raw_fts):
