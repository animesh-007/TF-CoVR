...
def main(args):
    ...
    if args.model_type == "coco":
        save_dir = args.save_dir / f"blip2-vid-embs-large-all"
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_dir", type=Path, default= "/home/agupta2/FinePseudo-CoVR/embeddings/CIRCO", help="Path to video directory"
    )
