...
# import vtn_helper
from src.model.blip2_frames.vtn_helper import VTNLongformerModel, pad_to_window_size_local
import yaml
# from mlp import mlp
...
class VTN(nn.Module):
    ...
    def forward(self, x, bboxes=None):
        ...
        x = self.temporal_encoder(input_ids=None,
                                  attention_mask=attention_mask, # [B, 36]
                                  token_type_ids=token_type_ids, # [B, 36]
                                  position_ids=position_ids, # [B, 36]
                                  inputs_embeds=x, # [B, 36, 768]
...
#   
    ...
    # print(vtn_model)
    # import importlib
    # spec = importlib.util.spec_from_file_location('params', cfg_file)
