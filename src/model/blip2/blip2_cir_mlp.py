...
class BLIP2Cir(Blip2Base):
    ...
    def __init__(
        ...
        logging.info("using MLP with BLIP")
        # import pdb; pdb.set_trace()
        self.combiner = Combiner(clip_feature_dim=256, projection_dim=256 * 4, hidden_dim=256 * 8)
    ...
    def forward(self, batch, fabric):
        ...
        # import pdb; pdb.set_trace()
        # ref_img_embs = concat_all_gather(ref_img_embs)
